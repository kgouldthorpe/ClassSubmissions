...
// =================================
d3.csv("data.csv").then(function(dowSmurfData) {
  ...
  // Format the data
  dowSmurfData.forEach(function(data) {
  ...
  var xTimeScale = d3.scaleTime()
    .domain(d3.extent(dowSmurfData, d => d.date))
    .range([0, width]);

  var yLinearScale1 = d3.scaleLinear()
    .domain([0, d3.max(dowSmurfData, d => d.dow_index)])
    .range([height, 0]);

  var yLinearScale2 = d3.scaleLinear()
    .domain([0, d3.max(dowSmurfData, d => d.smurf_sightings)])
    .range([height, 0]);
